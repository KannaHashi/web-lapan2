...
<body class="bg-white dark:bg-gray-900 dark:text-white transition-all">
    <div id="">
        ...
        <ul class="flex flex-col z-10 w-20 p-4 h-full items-center justify-center bg-zinc-900 dark:bg-slate-800 fixed" id="tabsl">
            ...
            <li class="flex tablink rounded-t p-0 justify-center w-full hover:cursor-pointer hover:bg-slate-800">
                <button class="tablinkd p-3" onclick="openTab(event, 'pleiades')" id="defaultOpen">
            ...
            <li class="flex tablink p-0 justify-center w-full hover:cursor-pointer hover:bg-slate-800">
                <button class="tablinkd p-3" onclick="openTab(event, 'spot')">
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-6 text-white">
            ...
            <li class="flex tablink p-0 justify-center w-full hover:cursor-pointer hover:bg-slate-800">
                <button class="tablinkd p-3" onclick="openTab(event, 'sar')">
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-6 text-white">
                        <path stroke-linecap="round" stroke-linejoin="round" d="M6 12 3.269 3.125A59.769 59.769 0 0 1 21.485 12 59.768 59.768 0 0 1 3.27 20.875L5.999 12Zm0 0h7.5" />
                    </svg>
                </button>
            </li>
            <li class="flex tablink rounded-b p-0 justify-center w-full hover:cursor-pointer hover:bg-slate-800">
                <button class="tablinkd p-3" onclick="openTab(event, 'landsat')">
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-6 text-white">
            ...
            <li class="flex tablink rounded-b p-0 justify-center w-full hover:cursor-pointer hover:bg-slate-800">
                <button class="tablinkd p-3" onclick="openTab(event, 'modis')">
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-6 text-white">
            ...
            <li class="flex tablink rounded-b p-0 justify-center w-full hover:cursor-pointer hover:bg-slate-800">
                <button class="tablinkd p-3" onclick="openTab(event, 'noaa')">
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-6 text-white">
            ...
            <li class="flex tablink rounded-b p-0 justify-center w-full hover:cursor-pointer hover:bg-slate-800">
                <button class="tablinkd p-3" onclick="openTab(event, 'metop')">
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-6 text-white">
            ...
            <li class="flex tablink rounded-b p-0 justify-center w-full hover:cursor-pointer hover:bg-slate-800">
                <button class="tablinkd p-3" onclick="openTab(event, 'npp')">
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-6 text-white">
            ...
            <li class="flex tablink rounded-b p-0 justify-center w-full hover:cursor-pointer hover:bg-slate-800">
                <button class="tablinkd p-3" onclick="openTab(event, 'maxar')">
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-6 text-white">
